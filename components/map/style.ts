...
export const MarkerStyle = [
  {
    ...
    height: '1.875rem',
    background: '#007AFF',
    backgroundImage: 'url("/assets/illustrations/icon3.png")',
    borderRadius: '50%',
    fontSize: '0.7rem',
    color: 'white',
    display: 'flex',
  ...
  },
  {
    ...
    height: '3.125rem',
    background: '#007AFF',
    backgroundImage: 'url("/assets/illustrations/icon2.png")',
    borderRadius: '50%',
    color: 'white',
    display: 'flex',
    justifyContent: 'flex-end',
  ...
  },
  {
    ...
    height: '4.375rem',
    fontSize: '0.9rem',
    backgroundImage: 'url("/assets/illustrations/icon1.png")',
    borderRadius: '50%',
    background: '007AFF',
    color: 'white',
    display: 'flex',
